...
mongoose
  .connect(
    "mongodb+srv://Iqbal:iqbalahmed@trafflow.ur3y5i4.mongodb.net/version1?retryWrites=true&w=majority"
  )
...
app.post("/submit-challan", (req, res) => {
  upload(req, res, (err) => {
    ...
    //   });
      ...
      // newImage.save().then(() =>).catch(err => res.send(err))
    }
  });
});
